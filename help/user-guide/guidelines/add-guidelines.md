...
Você pode adicionar [!DNL Products] no GenStudio for Performance Marketing para especificar áreas de foco de produto individuais ao criar conteúdo. <!-- Add Rename, display, reposition functionality -->
